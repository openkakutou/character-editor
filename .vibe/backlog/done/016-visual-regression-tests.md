...
- [x] Baseline screenshots exist for: the sprite browser showing a decoded sprite, the palette editor's preview after a color edit, and the animation editor's frame preview with Clsn boxes drawn (added, dragged, and resized)
